...
$message1='<table width="100%" bgcolor="#dfdfdf" border="0" cellspacing="10" cellpadding="0" style="padding-top:10px;">
  <tr>
    <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#ffffff; margin-top:0px;">
        <tr>
          <td bgcolor="#2d2d2d" height="36" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#e4e4e4;	text-align:left;	font-weight:bold; padding-left:14px;">New Registration Details</td>
        </tr>
        <tr>
          <td bgcolor="#30B1F2" style="line-height:3px;">&nbsp;</td>
        </tr>
                            ...
                            <tr>
                              <td><table align="center" border="0" cellspacing="10" width="100%"   style="background:#f7f7f7; border:1px solid #e8e8e8; -moz-border-radius:7px; -webkit-border-radius: 7px; -khtml-border-radius: 7px; border-radius: 7px;">
                                  <tbody>
								   ...
								   <tr>
                                      <td width="34%" style="font-size:11px;	font-family:Arial, Helvetica, sans-serif;	color:#000000;	text-align:left;	padding-left:15px;	font-weight:bold;">Name</td>
                                      <td width="4%" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#000;	text-align:left; line-height:20px;">:</td>
                                      <td width="62%" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#000;	text-align:left; line-height:20px;">'.$Select_usr['user_name'].'</td>
                                    </tr>
                                    ...
                                    <tr>
                                      <td style="font-size:11px;	font-family:Arial, Helvetica, sans-serif;	color:#000000;	text-align:left;	padding-left:15px;	font-weight:bold;">Mobile No</td>
            <td style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#000;	text-align:left; line-height:20px;">:</td>
                                      <td style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#000;	text-align:left; line-height:20px;">'.$Select_usr['user_mobile'].'</td>
                                    </tr>
