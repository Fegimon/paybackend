...
$fromname=SITE_NAME;
$sub="Product Return- ".$from;
$sub1="Thank you for your Product Return Request.";
$message='<table width="100%" bgcolor="#dfdfdf" border="0" cellspacing="10" cellpadding="0" style="padding-top:10px;">
	  <tr>
		<td><table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#ffffff; margin-top:0px;">
			<tr>
			  <td bgcolor="#2d2d2d" height="36" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#e4e4e4;	text-align:left;	font-weight:bold; padding-left:14px;">Product Return Request</td>
			</tr>
			<tr>
	...
	$message1='<table width="100%" bgcolor="#dfdfdf" border="0" cellspacing="10" cellpadding="0" style="padding-top:10px;">
	  <tr>
		<td><table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#ffffff; margin-top:0px;">
			<tr>
			  <td bgcolor="#2d2d2d" height="36" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#e4e4e4;	text-align:left;	font-weight:bold; padding-left:14px;">Thank you for your Product Return Request.</td>
			</tr>
			<tr>
			  <td bgcolor="#30B1F2" style="line-height:3px;">&nbsp;</td>
			</tr>
			...
			<tr>
			  <td style="padding-top:0px; padding-bottom:10px;"><table align="center" border="0" cellspacing="0" width="86%" style="margin-top:5px">
				  <tbody>
					...
					<tr>
					  <td height="30" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#3f3f3f; line-height:13pt;	text-align:justify; padding-bottom:5px;">Thanks for your Product Return Request.We will contact you soon.</td>
					</tr>
					<tr>
					  <td></td>
					</tr>
