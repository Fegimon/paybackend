...
<tr>
<td bgcolor="#2d2d2d" height="36" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#e4e4e4;	text-align:left;	font-weight:bold; padding-left:14px;">Password Reset</td>
</tr>
<tr>
	...
	<td style="padding:4px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
		<tr>
		  <td><table align="center" border="0" cellspacing="0" width="100%">
			  <tbody>
				<tr>
				  <td height="30" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#3f3f3f;	text-align:left;">Dear <span style="font-size:11px;	font-family:Arial, Helvetica, sans-serif;	color:#3f3f3f;	text-align:left; font-weight:bold; text-transform:uppercase;">'.$user_name.',</span></td>
				</tr>
				<tr>
				  <td height="30" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#3f3f3f; line-height:13pt;	text-align:justify; padding-bottom:5px;">Your login details are as below.</td>
				</tr>
				<tr>
				  <td><table align="center" border="0" cellspacing="10" width="100%"   style="background:#f7f7f7; border:1px solid #e8e8e8; -moz-border-radius:7px; -webkit-border-radius: 7px; -khtml-border-radius: 7px; border-radius: 7px;">
					  <tbody>
						<tr>
						  <td width="34%" style="font-size:11px;	font-family:Arial, Helvetica, sans-serif;	color:#000000;	text-align:left;	padding-left:15px;	font-weight:bold;">Username</td>
						  <td width="4%" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#000;	text-align:left; line-height:20px;">:</td>
						  <td width="62%" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#000;	text-align:left; line-height:20px;">'.$usermail.'</td>
						</tr>
						<tr>
						  ...
						  <td style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#000;	text-align:left; line-height:20px;">'.$userpass.'</td>
						</tr>
					  </tbody>
					</table></td>
				</tr>
