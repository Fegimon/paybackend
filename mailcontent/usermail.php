...
<?php 
$Sel = $conn->select_query(ORDER,"*","ord_id IN(".$selData.")","");

$from=$EXTRA_ARG['set_email'];
$fromname=SITE_NAME;
if($Sel['nr'])
{
	foreach($Sel['result'] as $resord)
	{
	
$sub=$subcont .'-'.$resord['order_id'];
 $userdetails = $conn->select_query(USER,"*","user_id='".$resord['customer_id']."'","1");
 $to=$userdetails['user_email'];

	
	$sel = $conn->select_query(ORDER,"*","ord_id='".$resord['ord_id']."'","1");
	
	$orderdet = $conn->select_query(ORDERPRODUCT,"*","order_id='".$resord['ord_id']."'","");

$userdetails = $conn->select_query(USER,"*","user_id='".$resord['customer_id']."'","1");
//billing add
$billingadd = $conn->select_query(USERADDRESS,"*","customer_id='".$resord['customer_id']."' AND address_id='".$resord['bill_add_id']."'","1");

//shipping add
$shippingadd = $conn->select_query(USERADDRESS,"*","customer_id='".$resord['customer_id']."' AND address_id='".$resord['ship_add_id']."'","1");


 $billstate = $conn->select_query(STATE,"*","zone_id='".$resord['bill_state']."'","1");
 $shipstate = $conn->select_query(STATE,"*","zone_id='".$resord['ship_state']."'","1");
 

$user = $conn->select_query(USER,"*","user_id='".$resord['customer_id']."'","1");
 $order_status = $conn->select_query(ORDERSTATUS,"*","order_status_id='".$resord['order_status_id']."' AND status='Y'","1");


if($resord['paymethod']=='COD')
					{
					$paymethod='Cash Payable';
					}else
					{
					$paymethod=$resord['paymethod'];
					}
...
$message='<table width="100%" bgcolor="#dfdfdf" border="0" cellspacing="10" cellpadding="0" style="padding-top:10px;">
  <tr>
                ...
                <td style="padding:4px;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
                    <tr>
                      <td><table align="center" border="0" cellspacing="0" width="100%">
						 ...
						 <tr>
								  <td height="30" style="font-size:12px;	font-family:Arial, Helvetica, sans-serif;	color:#3f3f3f;	text-align:left;">Dear <span style="font-size:11px;	font-family:Arial, Helvetica, sans-serif;	color:#3f3f3f;	text-align:left; font-weight:bold; text-transform:uppercase;">'.$userdetails['user_name'].'</span></td>
								</tr>
								
                        <tr>
                          <td width="72%" height="30" class="heading1">Order Details : '.$resord['order_id'].' </td>
    ...
    border: 1px solid #C3C3C3;" class="head_bg">
                          <td style="color: #2C2C2C; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; font-weight: bold; line-height: 16px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_head" height="28" colspan="2">Shopping Cart Items</td>
						   <td style="color: #2C2C2C; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; font-weight: bold; line-height: 16px; padding-left: 10px; text-align: left; text-decoration: none;" width="14%" class="form_head" height="28">Duration</td>
			 ...
			 foreach($orderdet['result'] as $resdet){
					...
					$monthdays=$resdet['month_days'];
                          ...
                          <td width="27%" style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" width="37%" width="63%" height="30" class="form_text">'.$resdet['quantity'] .' x Rs  '. round($resdet['security_deposite']+$resdet['handling_price']).' </td>
						    ...
						    <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif;     font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;"  class="form_text">'. $monthdays.'&nbsp;'.$dutext.'</td>
                          ...
                          $message.= '<tr>
                          <td colspan="6"><table width="121%" border="0" cellspacing="0" cellpadding="0">
                              <tbody>
                                 <tr class="row_color">
                                 
                                  <td colspan="5" style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif;     font-size: 12px; line-height: 40px; padding-left: 10px; text-align: right; text-decoration: none;"  valign="bottom" class="form_text">Total Deposit :</td>
                                  <td colspan="" style="width:25%; border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif;     font-size: 12px; line-height: 40px; padding-left: 10px; text-align: center; text-decoration: none;"   valign="bottom" class="form_text">Rs '. $totdep.'</td>
                                </tr>
                             
                                <tr class="row_color pull-right">
                                 
                                  <td colspan="5" style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif;     font-size: 12px; line-height: 40px;  text-align: right; text-decoration: none;" valign="bottom" class="form_text">Handling Charge :</td>
                                  <td colspan="" style="width:25%; border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif;     font-size: 12px; line-height: 40px; padding-left: 10px; text-align: center; text-decoration: none;"  valign="bottom" class="form_text">Rs '. $tothand .'</td>
                                </tr>
                                 <tr class="row_color pull-right">
                               
                                  <td colspan="5" style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif;     font-size: 12px; line-height: 40px; padding-left: 10px; text-align: right; text-decoration: none;"  valign="bottom" class="form_text">Total Payout :</td>
                                  <td colspan="" style="width:25%; border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif;     font-size: 12px; line-height: 40px; padding-left: 10px; text-align: center; text-decoration: none;"  valign="bottom" class="form_text">Rs '.round($sel['total']).'</td>
                                </tr>
                                <tr>
                    ...
                    <table width="98%" border="0" cellspacing="0" cellpadding="0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" width="37%" class="form_text"><strong>'.date('d-m-Y',strtotime($resord['ord_date'])).'</strong></td>
                        </tr>
                      </tbody>
                    </table></td>
                </tr>
 ...
 line-height: 16px; padding-left: 10px;text-align: left; text-decoration: none;" colspan="3" class="form_head" height="28">Billing Information</td>
                        ...
                        <tr>
                          ...
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">'.  $resord['bill_address'] .'</td>
                        </tr>
                        <tr class="row_color">
                          ...
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">:</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">'.  $resord['bill_city'].'</td>
                        </tr>
                        <tr>
                        ...
                        <tr class="row_color">
                          ...
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">:</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">'. $resord['bill_pincode'].'</td>
                        </tr>
                        <tr>
    ...
    border: 1px solid #C3C3C3;" class="head_bg">
                        ...
                        <tr>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" valign="top" class="form_text">Address</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" valign="top" class="form_text">:</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">'.  $resord['ship_address'] .'</td>
                        </tr>
                        <tr class="row_color">
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">City</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">:</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">'. $resord['ship_city'].'</td>
                        </tr>
                        <tr>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">State</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">:</td>
                        ...
                        <tr class="row_color">
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">Zip Code</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">:</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">'.$resord['ship_pincode'].'</td>
                        </tr>
                        <tr>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">Country</td>
                          <td style="border-bottom: 1px solid #f2f2f2; color: #515050; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; line-height: 40px; padding-left: 10px; text-align: left; text-decoration: none;" class="form_text">:</td>
