...
<div id="myModal-common" class="modal fade" role="dialog">
  <div class="modal-dialog"> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frm_unpay" id="frm_unpay" method="post">
          <div class="form-group">
            <label for="usname">Name:</label>
            <input type="text" class="form-control validate[required]" id="usname" placeholder="Name" name="usname">
          </div>
          <div class="form-group">
            <label for="usmail">Email:</label>
            <input type="text" class="form-control validate[required]" id="usmail" placeholder="Email" name="usmail">
          </div>
          <div class="form-group">
            <label for="usmob">Mobile No:</label>
            <input type="text" class="form-control validate[required]" id="usmob" placeholder="Mobile No" name="usmob">
          </div>
          <div class="form-group">
            <label for="usaddress">Address:</label>
            <textarea class="form-control validate[required]" rows="5" id="usaddress" name="usaddress" placeholder="Address"></textarea>
          </div>
          <div class="form-group">
         
          <div class="form-group">
            <label for="uscomment">Remarks:</label>
            <textarea class="form-control validate[required]" rows="5" id="uscomment" name="uscomment" placeholder="Remarks"></textarea>
          </div>
          <div class="text-center">
            <button type="submit" name="btn_unpay" id="btn_unpay" class="btn btn-default">Submit</button>
          </div>
        </form>
      </div>
    </div>
...
jQuery("#frm_unpay").validationEngine();
setTimeout("document.getElementById('usname').focus(); ", 500 ); 
});

</script><?php */?>

<?php /*?><script>
 $('a[data-target=#myModal_1]').on('click', function (ev) {
        ev.preventDefault();
         <?php if(isset($_SESSION['prentz_user_id'])) { ?>
		  $("#myModal_1").load(target, function () {
