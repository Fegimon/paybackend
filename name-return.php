...
$comments = $conn->select_query(NAMETRANSFER,"*",$cond . "order by name_trans_id desc","");
...
<div class="col-md-3 col-xs-12 col-sm-3">
   ...
   <ul id="category-list">
       ...
       <li class="category-menu active"><a href="<?php echo SITE_URL; ?>name-return.php"> Name Transfer</a></li>
...
<div class="order-detail wow fadeInDown">
   <h2 class="profile-title">Name Transfer</h2>
...
<div class="clear-fix"></div>
  ...
  <?php
      ...
      <tr>
        <td> <?php echo $i; ?></td>
        <td><?php echo $rescmnt['new_name']?></td>
        <td><?php echo $rescmnt['new_email']?></td>
        <td><?php echo $rescmnt['new_mobile']?></td>
        <td><?php echo $rescmnt['new_address']?></td>
      </tr>
       <?php $i++;} ?>
    </tbody>
  </table>
