...
$cart_total= $shopcart->getTotalAmount();
 ...
 $feat_loc = $conn->Execute("SELECT * FROM tbl__product prod RIGHT JOIN tbl__product_price price ON prod.p_id = price.pp_product_id WHERE price.pp_location_id='".$feat_loc['lo_id']."' AND price.pp_feature='Y' AND prod.p_status='Y' order by prod.p_position asc");
  ...
  <div class="row">
    ...
    <ul class="home-img-section-in">
      <li> 
        ...
        <a href="<?php echo SITE_URL; ?>category/<?php echo strtolower($current_location_name["lo_name"]); ?>/<?php echo 'rent-for-home'  ?>.html">
        <div class='wrapper action_hover wow fadeInDown' data-wow-duration="2s" style="visibility: visible; animation-name: fadeInDown;"> 
          ...
          <div class='description wrapper-default'> 
            ...
            <h3> Rent For Home</h3>
            <a href="<?php echo SITE_URL; ?>category/<?php echo strtolower($current_location_name["lo_name"]); ?>/<?php echo 'rent-for-home'  ?>.html" class="a-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Explore now</a> 
      ...
      <li> <a href="<?php echo SITE_URL; ?>category/<?php echo strtolower($current_location_name["lo_name"]); ?>/<?php echo 'rent-for-office'  ?>.html">
        <div class='wrapper wow fadeInDown' data-wow-duration="2s" style="visibility: visible; animation-name: fadeInDown;"> 
          ...
          <div class='description wrapper-default'>
            ...
            <a href="<?php echo SITE_URL; ?>category/<?php echo strtolower($current_location_name["lo_name"]); ?>/<?php echo 'rent-for-office'  ?>.html" class="a-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Explore now</a> </div>
          <!-- end description div --> 
          
        </div>
        </a> </li>
      <li> <a href="<?php echo SITE_URL; ?>category/<?php echo strtolower($current_location_name["lo_name"]); ?>/<?php echo 'rent-for-events'  ?>.html">
        <div class='wrapper wow fadeInDown' data-wow-duration="2s" style="visibility: visible; animation-name:fadeInDown;"> 
          <!-- image -->
          ...
          <div class='description wrapper-default'>
            <h3>Event Rentals</h3>
            <a href="<?php echo SITE_URL; ?>category/<?php echo strtolower($current_location_name["lo_name"]); ?>/rent-for-events.html" class="a-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Explore now</a> </div>
          <!-- end description div --> 
      ...
      <div class="home-image-two">
        <li> <a href="<?php echo SITE_URL; ?>service-request.html">
          <div class='wrapper wow fadeInUp' data-wow-duration="2s" style="visibility: visible; animation-name: fadeInUp;"> 
            ...
            <div class='description wrapper-default '> 
              ...
              <a href="<?php echo SITE_URL; ?>service-request.html" class="a-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Raise request</a> 
              <!-- end description content --> 
            </div>
            <!-- end description div --> 
        ...
        <li> <a href="<?php echo SITE_URL; ?>clearance-website.html">
          <div class='wrapper wow fadeInUp' data-wow-duration="2s" style="visibility: visible; animation-name: fadeInUp;"> 
            <!-- image -->
            ...
            <div class='description wrapper-default'>
              <h3>Buy</h3>
              <a href="<?php echo SITE_URL; ?>clearance-website.html" class="a-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Shop Online</a> </div>
            <!-- end description div --> 
            
          </div>
          </a> </li>
          <li> <a href="<?php echo SITE_URL; ?>business.html">
          <div class='wrapper wow fadeInUp' data-wow-duration="2s" style="visibility: visible; animation-name: fadeInUp;"> 
            <!-- image -->
            ...
            <div class='description wrapper-default'>
              ...
              <a href="<?php echo SITE_URL; ?>business.html" class="a-link"><i class="fa fa-angle-double-right" aria-hidden="true"></i>&nbsp;Learn More</a> </div>
            <!-- end description div --> 
    ...
    <div class="row">
      <div class="featured-product-section-in">
       ...
       <?php if($featrow>0){?>   <div class="product-arrow pull-right"><a class="btn prev"><i class="fa fa-chevron-left"></i></a> <a class="btn next"><i class="fa fa-chevron-right"></i></a> </div><?php }?>
        ...
        <div class="products-in">
         ...
         if($res['p_category']=='1')
         {
           $mcatslug='rent-for-home';
         }else if($res['p_category']=='2')
         {
           $mcatslug='rent-for-office';
         }else if($res['p_category']=='3')
         {
           $mcatslug='rent-for-events';
         }
     ...
     $prodimg= ($exist) ? "product/image/".$res['p_image'] : "images/product-1.png";   
              ...
              <div class="item-text">
                ...
                <h5><a href="<?php echo SITE_URL; ?>product-detail/<?php echo strtolower($current_location_name["lo_name"]); ?>/<?php echo $mcatslug; ?>/<?php echo $res['p_slug']  ?>.html"><?php echo $res['p_name'] ?></a></h5>
            ...
            <?php }else{?><div class="text-center txt-styl">
              <ul>
                <li> <i class="fa fa-warning"></i> &nbsp;No Record Found</li>
              </ul>
            </div>
...
<section id="banner-strip">
  ...
  <div class="container-fluid">
    <div class="row">
    <a href="<?php echo SITE_URL; ?>pages/<?php echo 'why-rent'; ?>.html">
      <div class="col-xs-12 col-md-3 col-lg-3 col-sm-3"> <img src="<?php echo SITE_URL; ?>images/wallet.png" class="img-responsive center-block  wow fadeInUp">
        <p class="icon-title">Why Rent? </p>
        <p class="icon-desc"><?php echo $conn->stripval($why['wrent']); ?></p>
      </div>
      </a>
       <a href="<?php echo SITE_URL; ?>pages/<?php echo 'how-it-works'; ?>.html">
       <!--col-->
      <div class="col-xs-12 col-md-3 col-lg-3 col-sm-3"> <img src="<?php echo SITE_URL; ?>images/time.png" class="img-responsive center-block wow fadeInUp">
        <p class="icon-title">How it works ? </p>
        <p class="icon-desc"><?php echo $conn->stripval($why['works']);?></p>
      </div>
      </a>
       <a href="<?php echo SITE_URL; ?>pages/<?php echo 'faq-how-it-works'; ?>.html">
        <!--col-->
      <div class="col-xs-12 col-md-3 col-lg-3 col-sm-3"> <img src="<?php echo SITE_URL; ?>images/service.png" class="img-responsive center-block wow fadeInUp">
        <p class="icon-title">FAQ </p>
        <p class="icon-desc"><?php echo $conn->stripval($why['faq']);?></p>
      </div>
      <!--col--> 
      </a>
       <a href="<?php echo SITE_URL; ?>pages/<?php echo 'rent-to-own'; ?>.html">
      <!--col-->
      <div class="col-xs-12 col-md-3 col-lg-3 col-sm-3"> <img src="<?php echo SITE_URL; ?>images/rent.png" class="img-responsive center-block wow fadeInUp">
        ...
        <p class="icon-desc"><?php echo $conn->stripval($why['own']);?></p>
      </div>
...
?>
        <div id="slide">
          <div class="row">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-2 col-sm-2 col-xs-12"> <div class="text-center"><img src="<?php echo $cmt_image; ?>" class="img-circle"> </div></div>
...
$json = file_get_contents(SITE_URL.'blog/wp-json/wp/v2/posts?_embed');
