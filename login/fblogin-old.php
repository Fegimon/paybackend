...
$redirectURL = 'http://192.168.1.30/payrentz-dev/login/fblogin.php'; //Callback URL
        ...
        if (isset($_GET['code'])) {
            ...
            try {
                ...
                if(!$usercheck['nr'])
                {
                    ...
                    $new = array('user_oauth_provider' => 'Facebook', 'user_oauth_uid' => $fbUserProfile['id'], 'user_name' => $fbUserProfile['name'], 'user_first_name' => $fbUserProfile['first_name'], 'user_last_name' => $fbUserProfile['last_name'], 'user_gender' => $fbUserProfile['gender'], 'user_locale' => $fbUserProfile['locale'], 'user_profile' => $fbUserProfile['picture'], 'user_email' => $fbUserProfile['email'], 'user_facebook' => $fbUserProfile['link'], 'user_status'=>'Y', 'user_ip'=>$user_ip, 'user_dt'=>NOW);
                   ...
                   if (isset($_SESSION['prentz_redirect'])) {
                    ...
                    $update = array('user_oauth_provider' => 'Facebook', 'user_oauth_uid' => $fbUserProfile['id'], 'user_name' => $fbUserProfile['name'], 'user_first_name' => $fbUserProfile['first_name'], 'user_last_name' => $fbUserProfile['last_name'], 'user_gender' => $fbUserProfile['gender'], 'user_locale' => $fbUserProfile['locale'], 'user_profile' => $fbUserProfile['picture'], 'user_email' => $fbUserProfile['email'], 'user_facebook' => $fbUserProfile['link'], 'user_ip'=>$user_ip, 'user_status'=>'Y');
