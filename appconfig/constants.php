...
$RES_SURL=$conn->settings();

if($RES_SURL['setting_fields']!="")
{
	$EXTRA_ARG = @unserialize($RES_SURL['setting_fields']);
	array_walk($EXTRA_ARG,'decode_ArrayWalk');
}

define('ADMIN_URL',$RES_SURL['set_url']."MyAdmin/");
define('EDITORJSPATH',$RES_SURL['set_url']."js/editor/assetmanager/asset.php");
define('SITE_URL', $RES_SURL['set_url']);
define('ADMIN_PATH',"MyAdmin");
define('SITE_NAME', $conn->stripval($RES_SURL['sitename']));
define('DBNAME', $App->components->db->dbname);
...
define('SMSUSER', $conn->stripval($EXTRA_ARG['smsuser']));
define('SMSPASS', $conn->stripval($EXTRA_ARG['smspass']));
define('SMSSENDERID', $conn->stripval($EXTRA_ARG['smssenderid']));
*/

if($EXTRA_ARG['cssurl']!="")
{
	define('CSS_URL', $EXTRA_ARG['cssurl']);
}else
{
...
#Upload temp folder
define('UPLOADTEMPFOLDER',"upload_temp/");

define('PREFIX','tbl__');
define('ADMIN',PREFIX.'admin');
define('ADMINMENU',PREFIX."adminmenu");
define('USER',PREFIX."user");
define('OPERATOR',PREFIX."operator");
define('COUNTRY',PREFIX."country");
define('STATE',PREFIX."state");
define('LOCATION',PREFIX."location");
define('CATEGORY',PREFIX."category");
define('Tax',PREFIX."tax");
define('TAX',PREFIX."tax");

define('Information',PREFIX."information");
define('INFORMATION',PREFIX."information");
define('TOPMENU',PREFIX."topmenu");

define('PAYMENTS',PREFIX."payments");
define('SERVICEREQUEST',PREFIX."servicerequest");
define('BUSINESSSOLUTION',PREFIX."businesssolution");
define('COMMONSERVICE',PREFIX."commonservice");
define('COMMONSERVICEREQUEST',PREFIX."commonservicerequest");
...
/* Location: ./appconfig/config/constants.php */
