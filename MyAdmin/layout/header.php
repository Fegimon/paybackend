...
unset($_SESSION['page'][$pageKey]);
?>
<?php
if($_SESSION['type']=='O')
{
	$sel_op=$conn->select_query(OPERATOR,"feat_id","op_id='".$_SESSION['admin_id']."'","1");
	$arr_feat_id=@explode(",",$sel_op['feat_id']);
}
...
<header class="main-header"> 
    ...
    <!-- Logo --> 
    <a href="<?php echo ADMIN_URL; ?>common/home.php" class="logo"> 
   ...
   <!-- Sidebar toggle button--> 
      <a href="#" id="navslide" class="sidebar-toggle" data-toggle="offcanvas" role="button"> <span class="sr-only">Toggle navigation</span> </a> 
      <!-- Navbar Right Menu -->
      <?php if($RES_SURL['setting_logo']!='')
{
	...
	$logoimg = ($logoexist) ? SITE_URL."uploads/common/".$RES_SURL['setting_logo'] : ADMIN_URL."img/logo.png";?>
      <img style="padding:3px 3px" src="<?php echo SITE_URL; ?>timthumb.php?src=<?php echo $logoimg;?>&h=43&zc=0&q=95" alt="<?php echo SITE_NAME; ?>" title="<?php echo SITE_NAME; ?>"   />
      <?php }?>
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
        <li></li>
        <li class="user user-menu"><a id="timedisplay"><?php echo date("D").", ".date('d-M-Y');?>&nbsp;<?php echo "-"; ?>&nbsp;<span id="time"><?php echo date('g:i:s a') ?></span></a></li>
          ...
          <li class="dropdown user user-menu"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">  <span class="hidden-xs">Welcome </span><span class="user_name"><strong><?php echo ($_SESSION['type']=="admin")?"Admin":$_SESSION['admin_name'];?></strong></span> </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <?php /*?><li class="user-header"> <img src="dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" />
              ...
              <li class="user-footer">
                <div class="pull-left"> <a href="<?php echo ADMIN_URL; ?>common/changepassword.php" class="btn btn-default btn-flat">Change password</a> </div>
                <div class="pull-right"> <a href="<?php echo ADMIN_URL.'common/logout.php'; ?>" class="btn btn-default btn-flat" onClick="return confirm('Are you sure want to Sign out?');">Sign out</a> </div>
              </li>
            </ul>
          </li>
           <li class="tasks-menu"><a href="<?php echo ADMIN_URL.'common/logout.php'; ?>" title="Logout" onClick="return confirm('Are you sure want to Sign out?');" > <i class="fa fa-unlock"></i>  </a></li>
          <?php /*?><!-- Control Sidebar Toggle Button -->
          <li> <a href="#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a> </li><?php */?>
        </ul>
      </div>
    </nav>
  </header>