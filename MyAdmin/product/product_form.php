...
//echo $cat_p_id;exit;
    ...
    if($ins)
    {
		$succAlert = "Successfully Updated.";
			...
			$rpage=ADMIN_URL.$path_folder.'product_img.php?q='.$id.'';
			$conn->divert($rpage); 
...
if(isset($add))
{
  ...
  $new = array('p_name'=>$product_name, 'p_slug' =>$product_slug, 'p_image'=>$post_image, 'p_desc' =>$product_desc, 'p_sub_category' =>$p_sub_cat,  'p_status'=>'Y', 'p_date_dt'=>NOW);
      ...
      if($ins){
		  ...
		  $succAlert = "Successfully Updated.";
			$conn->adminAlert($pageKey,$succAlert);
			$rpage=(isset($_REQUEST['rpage']))? base64_decode($_REQUEST['rpage']):ADMIN_URL.$path_folder.'product_img.php?q='.$id.'';
			$conn->divert($rpage); 
            ...
            <div class="box-body">
              <form role="form" method="post" name="frm_new" id="frm_new" action="" enctype="multipart/form-data">
               ...
               <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li role="presentation" class="active" ><a href="<?php echo ADMIN_URL.$path_folder; ?>product_form.php?q=<?php echo $id?>" aria-controls="home" >General</a></li>
...
<!-- <div id="hidden_div" style="display: none;"><a href="#event_price" aria-controls="event_price" role="tab" data-toggle="tab">Rent for Event</a></div> -->
                    ...
                    <div class=" mg-top">
                      <div class="">
                        ...
                        <div class="form-group">
                          ...
                          <input  name="product_slug" id="product_slug" type="text" class="form-control validate[required,funcCall[checkslug]]" placeholder="Enter Slug" maxlength="200" onKeyUp="slug(this.value,'product_slug');" value="<?php echo $sel['p_slug']; ?>" onChange="slug(this.value,'product_slug');" onBlur="slug(this.value,'product_slug');"  />
                        </div>

                     <!--<div class="form-group">
                          <label for=""> Search Key <span class="text-red"> *</span></label>
                          <input  name="search_key" id="search_key" type="text" class="form-control validate[required]" placeholder="Enter Search Key" maxlength="200" onKeyUp="slug(this.value,'search_slug');" value="<?php echo $sel['p_name']; ?>" onChange="slug(this.value,'search_slug');" onBlur="slug(this.value,'search_slug');"/>
                          <div class="error_p_name"></div>
                        </div> 
                        <div class="form-group">
                          <label for="">Search Key<span class="text-red"> *</span></label>
                        ...
                        <div class="form-group">
                          <label for=""> Search Slug <span class="text-red"> *</span></label>
                          <input  name="search_slug" id="search_slug" type="text" class="form-control validate[required]" placeholder="Enter Slug" maxlength="200" onKeyUp="slug(this.value,'search_slug');" value="<?php echo $sel['search_slug']; ?>" onChange="slug(this.value,'search_slug');" onBlur="slug(this.value,'search_slug');"  />
                        </div>-->
                        <div class="form-group">
                          <label for="">Search Key<span class="text-red"> *</span></label>
                          <input  name="meta_key" id="meta_key" type="text" class="form-control validate[required]" placeholder="Enter Search Key"  value="<?php echo $sel['meta_key']; ?>"  />
                        </div>
	...
	$subcat = $conn->select_query(CATEGORY,"*","cat_status='Y' AND cat_p_id='".$sel['p_category']."' order by cat_title","");
                        ...
                        <div class="form-group">
                          <label>Sub Category<span class="text-red">*</span></label>
                           <span id="locdiv">
                          <select  class="form-control validate[required]" name="p_sub_cat[]" id="p_sub_cat">
                            <option value="">-- Select --</option>
  ...
  <option <?php if(in_array($ressub['cat_id'],$subimp)){?> selected="selected" <?php }?>  value="<?php echo $ressub['cat_id']; ?>"><?php echo ucfirst($conn->stripval($ressub['cat_title'])); ?></option>
                          ...
                          <?php }?>
                          <div class="form-group">
                          <label for="">Position<span class="text-red"> *</span></label>
                          <input  name="p_position" id="p_position" type="text" class="form-control validate[required]" 
                          placeholder="Position"  value="<?php echo $sel['p_position']; ?>" maxlength="3" />
                        </div>
                        <div class="form-group">
                          <label for="">Cover Image (271*271)<span class="text-red"> *</span></label>
                          <div id="imageblock">
                            <?php if($sel['p_image']!=""){?>
                ...
                <div class="form-group">
                  ...
                  <span class="text-light-blue" style="font-size:12px;"> Most search engines use a maximum of 200 chars for the Keywords.</span> </div><?php */?>
                      </div>
                    </div>
                  </div>
