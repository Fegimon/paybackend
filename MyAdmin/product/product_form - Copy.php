...
//echo $cat_p_id;exit;
    ...
    if($ins)
    {
		...
		$succAlert = "Successfully Updated.";
			...
			$rpage=(isset($_REQUEST['rpage']))? base64_decode($_REQUEST['rpage']):ADMIN_URL.$path_folder.'product_form.php?tab=img&q='.$id.'';
			$conn->divert($rpage); 
        ...
        if(isset($_POST['product_specification'])){
          ...
          foreach ($_POST['product_specification'] as $key => $value) {
			...
			$succAlert = "Successfully Updated.";
			$conn->adminAlert($pageKey,$succAlert);
			$rpage=(isset($_REQUEST['rpage']))? base64_decode($_REQUEST['rpage']):ADMIN_URL.$path_folder.'product_form.php?tab=price&q='.$id.'';
			$conn->divert($rpage); 
          }
        } 
         ...
         if(isset($_POST['images_table_details'])){
          ...
          foreach ($_POST['images_table_details'] as $key => $value) {
			...
			$succAlert = "Successfully Updated.";
			$conn->adminAlert($pageKey,$succAlert);
			$rpage=(isset($_REQUEST['rpage']))? base64_decode($_REQUEST['rpage']):ADMIN_URL.$path_folder.'product_form.php?tab=spec&q='.$id.'';
			$conn->divert($rpage); 
          }
            ...
            <div class="box-body">
              <form role="form" method="post" name="frm_new" id="frm_new" action="" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" <?php if($tab==''){?> class="active" <?php } ?>><a href="#home" aria-controls="home" role="tab" data-toggle="tab">General</a></li>
                  <li role="presentation" <?php if($tab=='img'){?> class="active" <?php } ?>><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Product Image</a></li>
                  <li role="presentation" <?php if($tab=='spec'){?> class="active" <?php } ?>><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Specifications</a></li>
                  <li role="presentation" id="month_div" <?php if($tab=='price'){?> class="active" <?php } ?>><a href="#house_price" aria-controls="house_price" role="tab" data-toggle="tab">Rent For Month</a>
...
<!-- <div id="hidden_div" style="display: none;"><a href="#event_price" aria-controls="event_price" role="tab" data-toggle="tab">Rent for Event</a></div> -->
                ...
                <div class="tab-content">
                  <div role="tabpanel" class="tab-pane <?php if($tab==''){?> active <?php } ?>" id="home">
                    <div class=" mg-top">
                      <div class="">
  ...
  <option <?php if(in_array($ressub['cat_id'],$subimp)){?> selected="selected" <?php }?>  value="<?php echo $ressub['cat_id']; ?>"><?php echo ucfirst($conn->stripval($ressub['cat_title'])); ?></option>
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($tab=='img'){?> active <?php } ?>" id="profile">
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($tab=='spec'){?> active <?php } ?>" id="messages">
                    <div class="row mg-top">
                      <div class="table-responsive">
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($tab=='price'){?> active <?php } ?>" id="house_price">
                    <div class="row mg-top">
                      <div class="col-md-12">
                        <div class="table-responsive">
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($tab=='price'){?> active <?php } ?>" id="event_price">
                    <div class="row mg-top">
                      <div class="col-md-12">
                        <div class="table-responsive">
                          <input type="hidden" id="getselectedservices" value="">
