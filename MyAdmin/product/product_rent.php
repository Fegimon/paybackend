        ...
        if(isset($_POST['event_price_details'])){
         // print_r($_POST['event_price_details']); exit;
          ...
          foreach ($_POST['event_price_details'] as $key => $value) {
            $event_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'ep', 'pp_product_id'=>$id, 'pp_location_id'=>$value['location_id'], 'ps_price_month'=>$value['per_month'],'pp_feature'=>$value['features'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'],'pp_seo_title'=>$value['seo_title'],'pp_seo_keyword'=>$value['seo_keyword'],'pp_seo_desc'=>$value['seo_desc'], 'pp_dt'=>NOW);
...
if(isset($add))
{
  ...
  $new = array('p_name'=>$product_name, 'p_slug' =>$product_slug, 'p_image'=>$post_image, 'p_desc' =>$product_desc, 'p_sub_category' =>$p_sub_cat,  'p_status'=>'Y', 'p_date_dt'=>NOW);
      ...
      if($ins){
        ...
        if(isset($_POST['event_price_details'])){
          foreach ($_POST['event_price_details'] as $key => $value) {
            $event_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'ep', 'pp_product_id'=>$ins['id'], 'pp_location_id'=>$value['location_id'], 'ps_price_month'=>$value['per_month'],'pp_feature'=>$value['features'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'],'pp_seo_title'=>$value['seo_title'],'pp_seo_keyword'=>$value['seo_keyword'],'pp_seo_desc'=>$value['seo_desc'], 'pp_dt'=>NOW);
            $event_price_ins = $conn->insert(PRODUCTPRICE,"",$event_price_add);
          }
        }
 ...
 //POST_DOCUMENT
  ...
  $taxs = $conn->select_query(TAX,"*","tax_status='Y' order by tax_pos","");
            ...
            <div class="box-body">
              <form role="form" method="post" name="frm_new" id="frm_new" action="" enctype="multipart/form-data">
               ...
               <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li role="presentation" ><a href="<?php echo ADMIN_URL.$path_folder; ?>product_spec.php?q=<?php echo $id?>" aria-controls="home" >Specifications</a></li>
                  
                  <li role="presentation" id="month_div" <?php if($sel['p_category']!='3') {echo 'class="active"';}?>><a href="<?php echo ADMIN_URL.$path_folder; ?>product_rent.php?q=<?php echo $id?>" aria-controls="home" >Rent For Month</a>
...
<li role="presentation" id="hidden_div" style="display: none;" <?php if($sel['p_category']=='3') {echo 'class="active"';}?>><a href="<?php echo ADMIN_URL.$path_folder; ?>product_rent.php?q=<?php echo $id?>" aria-controls="event_price" >Rent for Event</a></li>
...
<!-- <div id="hidden_div" style="display: none;"><a href="#event_price" aria-controls="event_price" role="tab" data-toggle="tab">Rent for Event</a></div> -->
  ...
  <option <?php if(in_array($ressub['cat_id'],$subimp)){?> selected="selected" <?php }?>  value="<?php echo $ressub['cat_id']; ?>"><?php echo ucfirst($conn->stripval($ressub['cat_title'])); ?></option>
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($sel['p_category']!='3') {echo 'active';}?>" id="house_price">
                    <div class="row mg-top">
                      <div class="col-md-12">
                        <div class="table-responsive">
                          ...
                          <table id="hp_price" class="table table-striped table-bordered table-hover">
                            <thead>
                              <tr>
                                ...
                                <td class="text-left">Rent for 1 Month </td>
                                <td class="text-left">Rent for 2 Month </td>
                                <td class="text-left">Rent for 3 Month </td>
                                <td class="text-left">Rent for above 3 Month </td> 
                                ...
                                <td class="text-left">Seo keyword</td>
                                <td class="text-left">Seo desc </td>
                              </tr>
                            </thead>
                            <tbody>
                              <?php
                    if($id){
                     ...
                     $document_row = 0; ?>
                              <?php if(isset($document_details)){ foreach ($document_details['result'] as $document_detail) {
								   ?>
                              <tr class="style-inp" id="price-row<?php echo $document_row; ?>">
                          ...
                          ?>
                                ...
                                <td class="text-right"><input type="text" name="product_price_detail[<?php echo $document_row; ?>][pp_price_3_month]" value="<?php echo round($document_detail['pp_price_3_month']); ?>" class="form-control" /></td>
                                 <td class="text-right"><input type="text" name="product_price_detail[<?php echo $document_row; ?>][pp_price_6_month]" value="<?php echo round($document_detail['pp_price_6_month']); ?>" class="form-control" /></td>
                                <td class="text-right"><input type="text" name="product_price_detail[<?php echo $document_row; ?>][pp_price_9_month]" value="<?php echo round($document_detail['pp_price_9_month']); ?>" class="form-control" /></td> 
                               <td class="text-right"><input type="text" name="product_price_detail[<?php echo $document_row; ?>][pp_price_12_month]" value="<?php echo round($document_detail['pp_price_12_month']); ?>" class="form-control" /></td> 
                       ...
                       if($tax_value['tax_id']==$document_detail['pp_taxes']) {
                          ?>
                                ...
                                <td class="text-right"><input type="text" name="product_price_detail[<?php echo $document_row; ?>][handling_charge]" value="<?php echo round($document_detail['pp_handling_charge']); ?>" class="form-control" /></td>
                                 <td class="text-right"><input type="text" name="product_price_detail[<?php echo $document_row; ?>][seo_title]" value="<?php echo $document_detail['pp_seo_title']; ?>" class="form-control form-control-seo" /></td> 
                                 
                                 <td class="text-right"><textarea name="product_price_detail[<?php echo $document_row; ?>][seo_keyword]" cols="35" rows="3" class=""  /><?php echo $document_detail['pp_seo_keyword']; ?></textarea></td> 
                                 
                                 <td class="text-right"><textarea name="product_price_detail[<?php echo $document_row; ?>][seo_desc]" value="" cols="35" rows="3" class="" /><?php echo $document_detail['pp_seo_desc']; ?></textarea></td> 
                  ...
                  <div role="tabpanel" class="tab-pane <?php if($sel['p_category']=='3') {echo 'active';}?>" id="event_price">
                    <div class="row mg-top">
                      <div class="col-md-12">
                        <div class="table-responsive">
                          <input type="hidden" id="getselectedservices" value="">
                    ...
                    if($id){
                     ...
                     $ep_price_row = 0; ?>
                              ...
                              <tr id="ep-price-row<?php echo $ep_price_row; ?>" class="style-inp">
    ...
    <option value="N" <?php  if($document_detail['pp_feature']=='N') { ?> selected="selected"<?php }?>>No</option>  
          <option value="Y" <?php  if($document_detail['pp_feature']=='Y') { ?> selected="selected"<?php }?>>Yes</option>
                              ...
                              <?php /*?>  <td class="text-right"><input type="text" name="event_price_details[<?php echo $ep_price_row; ?>][per_month]" value="<?php echo round($document_detail['ps_price_month']); ?>" class="form-control" /></td>
                       ...
                       if($tax_value['tax_id']==$document_detail['pp_taxes']) {
                          ?>
                                ...
                                <td class="text-right"><input type="text" name="event_price_details[<?php echo $ep_price_row; ?>][security_deposit]" value="<?php echo round($document_detail['pp_security_deposit']); ?>" class="form-control" /></td><?php */?>
                                <td class="text-right"><input type="text" name="event_price_details[<?php echo $ep_price_row; ?>][handling_charge]" value="<?php echo round($document_detail['pp_handling_charge']); ?>" class="form-control" /></td>
                                  ...
                                  <td class="text-right"><input type="text" name="event_price_details[<?php echo $ep_price_row; ?>][seo_title]" value="<?php echo $document_detail['pp_seo_title']; ?>" class="form-control form-control-seo" /></td> 
                                 
                                 <td class="text-right"><textarea name="event_price_details[<?php echo $ep_price_row; ?>][seo_keyword]" cols="35" rows="3" class=""  /><?php echo $document_detail['pp_seo_keyword']; ?></textarea></td> 
                                 
                                 <td class="text-right"><textarea name="event_price_details[<?php echo $ep_price_row; ?>][seo_desc]" value="" cols="35" rows="3" class="" /><?php echo $document_detail['pp_seo_desc']; ?></textarea></td> 
...
function filedadd(document_row){
   var addpricehtml  = '<tr class="style-inp" id="price-row' + document_row + '">'; 
   ...
   addpricehtml += '  <td class="text-right"><input type="text" name="product_price_detail[' + document_row + '][pp_price_6_month]" class="form-control" /></td>';
    ...
    addpricehtml += '  <td class="text-right"><input type="text" name="product_price_detail[' + document_row + '][handling_charge]" class="form-control" /></td>';  
	  ...
	  addpricehtml += '  <td class="text-right"><input type="text" name="product_price_detail[' + document_row + '][seo_title]" class="form-control form-control-seo" /></td>';  
	  
	   addpricehtml += '  <td class="text-right"><textarea name="product_price_detail[' + document_row + '][seo_keyword]"  cols="35" rows="3"/></textarea></td>'; 
	   
	    addpricehtml += '  <td class="text-right"><textarea name="product_price_detail[' + document_row + '][seo_desc]"  cols="35" rows="3"/></textarea></td>'; 
...
function opfiledadd(op_price_row){
   var addpricehtml  = '<tr class="style-inp" id="op-price-row' + op_price_row + '">'; 
...
function epfiledadd(ep_price_row){
   var addpricehtml  = '<tr class="style-inp" id="ep-price-row' + ep_price_row + '" class="style-inp">'; 
 ...
 //   addpricehtml += '  <td class="text-right"><input type="text" name="event_price_details[' + ep_price_row + '][security_deposit]" class="form-control" /></td>';
    ...
    addpricehtml += '  <td class="text-right"><input type="text" name="event_price_details[' + ep_price_row + '][handling_charge]" class="form-control" /></td>'; 
	  ...
	  addpricehtml += '  <td class="text-right"><input type="text" name="event_price_details[' + ep_price_row + '][seo_title]" class="form-control form-control-seo" /></td>';  
	  
	   addpricehtml += '  <td class="text-right"><textarea name="event_price_details[' + ep_price_row + '][seo_keyword]"  cols="35" rows="3"/></textarea></td>'; 
	   
	    addpricehtml += '  <td class="text-right"><textarea name="event_price_details[' + ep_price_row + '][seo_desc]"  cols="35" rows="3"/></textarea></td>'; 
