        ...
        if(isset($_FILES['product_image_detail'])){
          $i=0;
		   ...
		   $succAlert = "Successfully Updated.";
			...
			$rpage=(isset($_REQUEST['rpage']))? base64_decode($_REQUEST['rpage']):ADMIN_URL.$path_folder.'product_spec.php?q='.$id.'';
			$conn->divert($rpage); 
            ...
            <div class="box-body">
              <form role="form" method="post" name="frm_new" id="frm_new" action="" enctype="multipart/form-data">
               ...
               <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li role="presentation" class="active"><a href="<?php echo ADMIN_URL.$path_folder; ?>product_img.php?q=<?php echo $id?>" aria-controls="home" >Product Image</a></li>
                    ...
                    <div class="row mg-top">
                      <div class="table-responsive">
                        <table id="fileimage" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
                              <td class="text-left">Product Image Upload ( 680 * 550)</td>
                            </tr>
                          </thead>
                          <tbody>
                            <?php 
