...
function checkslug(field, rules, i, options)
{
  ...
  if(field.val()!="")
  {
    $.ajax({url: '<?php echo ADMIN_URL.$path_folder."ajax.php" ?>',type: 'post',async:false,data:{ "func": "subslug", "id": $('#product_slug').val(),'edit':'<?php echo $sel['p_id']; ?>','cat':'<?php echo $sel['p_id']; ?>' },
