            ...
            <div class="box-body">
              <form role="form" method="post" name="frm_edit" id="frm_edit" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input  name="cat_title" id="cat_title" type="text" class="form-control validate[required]" placeholder="Enter Title" maxlength="200" onKeyUp="slug(this.value,'cat_slug');" onChange="slug(this.value,'cat_slug');" onBlur="slug(this.value,'cat_slug');" value="<?php echo $conn->stripval($sel['cat_title']);?>" readonly="readonly" />
                </div>
        <div class="form-group">
