...
$sel = $conn->select_query(NAMETRANSFER,"*","name_trans_id='".$id."'","1");
 $order_status = $conn->select_query(SERVICEREQUEST,"*","status='".$sel['status']."' AND status='Y'","1");
   $orders = $conn->select_query(ORDER,"*","ord_id ='".$sel['main_ord_id']."'","1");
    $users = $conn->select_query(USER,"*","user_id ='".$sel['user_id']."'","1");
?>
<?php #Admin Html head
$conn->adminHtmlhead();
$conn->admninBody();
              ...
              <form role="form" class="form-horizontal" >
                <!-- text input -->
                 ...
                 <dl class="dl-horizontal">
                  <dt>User Name :</dt>
                  <dd><?php echo $conn->stripval(ucfirst($users['user_name']));?></dd>
                </dl>
                
                <dl class="dl-horizontal">
                  <dt>Order Id :</dt>
                  <dd><?php echo $conn->stripval($orders['order_id']);?></dd>
                </dl>
                
                 <dl class="dl-horizontal">
                  <dt>Product Name :</dt>
                  <dd><?php echo ucfirst($sel['prod_name']);?></dd>
                </dl>
                <dl class="dl-horizontal">
                  <dt>New Name :</dt>
                  <dd><?php echo ucfirst($sel['new_name']);?></dd>
                </dl>	
                
                  <dl class="dl-horizontal">
                  <dt>New Email :</dt>
                  <dd><?php echo ucfirst($sel['new_email']);?></dd>
                </dl>
                
                  <dl class="dl-horizontal">
                  <dt>New Mobile :</dt>
                  <dd><?php echo ucfirst($sel['new_mobile']);?></dd>
                </dl>
                
                  <dl class="dl-horizontal">
                  <dt>New Address :</dt>
                  <dd><?php echo ucfirst($sel['new_address']);?></dd>
                </dl>			        
                <!-- <dl class="dl-horizontal">
