          ...
          <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="printback-bg">
                  ...
                  <div class="">&nbsp;</div>
                  <div class="col-lg-12 print-border">
                     <h3><b>Personal Details - <?php echo $conn->stripval($sel['payrentz_unique']);?></b></h3>
                  </div>
                ...
                <div class="col-lg-3">
                   <p><b>Date Of Birth:</b> <?php  if($sel['dob']!='0000-00-00'){ echo $conn->stripval(date('d-m-Y',strtotime($sel['dob'])));}else{echo '---';}?></p>
                 </div>
                <div class="col-lg-3">
                   <p><b>Gender:</b> <?php echo $sel['user_gender']; ?></p>
                </div>
                <div class="col-lg-6">
                   <p><b>Marital Status:</b> <?php echo ($sel['marital_Status']=='S'?'Single':'Married');?></p>
                </div>
