...
$id = $conn->variable($q);
$sel = $conn->select_query(COMMONSERVICE,"*","id='".$id."'","1");
if(!$sel['nr'] && !empty($id))
{
...
if(isset($edit))
{
  ...
  if($brand_image)
  {
    ...
    $ins = $conn->update(COMMONSERVICE,"id='".$id."'",$new);
    if($ins)
    {
...
if(isset($add))
{
	...
	{ 
		...
		$ins = $conn->insert(COMMONSERVICE,"",$new);
		if($ins)
		{
                ...
                <div class="box-body">
                  <form role="form" method="post" name="frm_new" id="frm_new" action="" enctype="multipart/form-data">
                    <!-- text input -->
                      ...
                      <input  name="name" id="team_name" type="text" value="<?php echo $conn->stripval(ucfirst($sel['name']));?>" class="form-control validate[required]" placeholder="Enter Name" maxlength="200" />
                    </div>
                    <div class="form-group">
                  ...
                  <div id="imageblock">
                    ...
                    <?php }?>
                       ...
                       <label>SEO Details<span class="text-red">*</span></label>
                    <div class="form-group">
                      <label>Description<span class="text-red">*</span></label>
                      <input  name="description" id="description" type="text" value="<?php echo $conn->stripval(ucfirst($sel['description']));?>" class="form-control validate[required]" placeholder="Enter Name" maxlength="200" />
                    </div>



                      <div class="form-group">
                      <label>Key Word<span class="text-red">*</span></label>
                      <input  name="keywords" id="keywords" type="text" value="<?php echo $conn->stripval(ucfirst($sel['keywords']));?>" class="form-control validate[required]" placeholder="Enter Name" maxlength="200" />
                    </div>
