...
//$conn->valoperator("2");
$listcounts=$conn->getRow("Select * from (select count(brand_id) as actcount from ".BRAND." WHERE brand_status='Y' limit 1)as a,(select count(brand_id)inactcount   from ".BRAND." WHERE brand_status='N'  limit 1)as b");
 ?>
<div class="row">
