...
$cond = ($token=="inactive") ? "order_status_id!=''" : "order_status_id!=''";
...
$sql1="select * from tbl__order where  $cond AND payment_status='confirmed' AND paymethod='ONLINE' order by ord_id DESC";
//print_r($sql1);
              ...
              <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-hover">
                  <tr class="bg-gray color-palette">
                    <th class="head_text" width="3%">#</th>
                    <th class="head_text" width="12%">Order ID</th>
                    <th class="head_text" width="10%">User Name </th>
                     <th class="head_text" width="8%">Pay Mode</th>
                      <th class="head_text" width="14%">Delivery City</th>
                       <th class="head_text" width="13%">Payment Status</th>
                    <th class="head_text" width="11%">Order Status</th>
                    <th class="head_text" width="8%">Total</th>
                     <th class="head_text" width="10%">Order Date</th>
                ...
                }else
                {
                  ...
                  <tr class="tbldatarow">
                   ...
                   <?php /* ?> <td class="td_text"><a class="btn btn-default" href="<?php echo $path_folder."form.php"?>?q=<?php echo $res['tax_id'].'&rpage='.base64_encode($conn->getOwnURL());?>"  title="Edit"><i class="fa fa-edit"></i></a></td><?php */ ?>
                    ...
                    <?php /*?><td class="td_text"><a class="btn btn-default" href="<?php echo $path_folder."print.php"?>?q=<?php echo $res['ord_id'];?>"  title="Print"><i class="fa fa-file-text"></i></a></td>
