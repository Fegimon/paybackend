        ...
        if(isset($_POST['product_price_detail'])){
         // print_r($_POST['product_price_detail']); exit;
          ...
          foreach ($_POST['product_price_detail'] as $key => $value) {
            $houe_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'hp', 'pp_product_id'=>$id, 'pp_location_id'=>$value['location_id'], 'ps_price_month'=>$value['per_month'], 'pp_price_3_month'=>$value['pp_price_3_month'], 'pp_price_6_month'=>$value['pp_price_6_month'], 'pp_price_9_month'=>$value['pp_price_9_month'], 'pp_price_12_month'=>$value['pp_price_12_month'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'], 'pp_dt'=>NOW);
        ...
        if(isset($_POST['office_price_details'])){
         // print_r($_POST['office_price_details']); exit;
          ...
          foreach ($_POST['office_price_details'] as $key => $value) {
            $office_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'op', 'pp_product_id'=>$id, 'pp_location_id'=>$value['location_id'], 'pp_price_3_month'=>$value['pp_price_3_month'], 'pp_price_6_month'=>$value['pp_price_6_month'], 'pp_price_9_month'=>$value['pp_price_9_month'], 'pp_price_12_month'=>$value['pp_price_12_month'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'], 'pp_dt'=>NOW);
        ...
        if(isset($_POST['event_price_details'])){
         // print_r($_POST['event_price_details']); exit;
          ...
          foreach ($_POST['event_price_details'] as $key => $value) {
            $event_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'ep', 'pp_product_id'=>$id, 'pp_location_id'=>$value['location_id'], 'ps_price_month'=>$value['per_month'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'], 'pp_dt'=>NOW);
...
if(isset($add))
{
  ...
  $new = array('p_name'=>$product_name, 'p_slug' =>$product_slug, 'p_image'=>$post_image, 'p_desc' =>$product_desc, 'p_sub_category' =>$p_sub_cat,  'p_status'=>'Y', 'p_date_dt'=>NOW);
      ...
      if($ins){
        ...
        if(isset($_POST['product_price_detail'])){
          foreach ($_POST['product_price_detail'] as $key => $value) {
            $houe_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'hp', 'pp_product_id'=>$ins['id'], 'pp_location_id'=>$value['location_id'], 'pp_price_3_month'=>$value['pp_price_3_month'], 'pp_price_6_month'=>$value['pp_price_6_month'], 'pp_price_9_month'=>$value['pp_price_9_month'], 'pp_price_12_month'=>$value['pp_price_12_month'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'], 'pp_dt'=>NOW);
            $houe_price_ins = $conn->insert(PRODUCTPRICE,"",$houe_price_add);
          }
        }
        ...
        if(isset($_POST['office_price_details'])){
          foreach ($_POST['office_price_details'] as $key => $value) {
            $office_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'op', 'pp_product_id'=>$ins['id'], 'pp_location_id'=>$value['location_id'], 'pp_price_3_month'=>$value['pp_price_3_month'], 'pp_price_6_month'=>$value['pp_price_6_month'], 'pp_price_9_month'=>$value['pp_price_9_month'], 'pp_price_12_month'=>$value['pp_price_12_month'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'], 'pp_dt'=>NOW);
            $office_price_ins = $conn->insert(PRODUCTPRICE,"",$office_price_add);
          }
        }
        ...
        if(isset($_POST['event_price_details'])){
          foreach ($_POST['event_price_details'] as $key => $value) {
            $event_price_add=array('pp_id'=>$value['pp_id'], 'pp_price_option'=>'ep', 'pp_product_id'=>$ins['id'], 'pp_location_id'=>$value['location_id'], 'ps_price_month'=>$value['per_month'], 'pp_taxes'=>$value['taxes'], 'pp_security_deposit'=>$value['security_deposit'], 'pp_handling_charge'=>$value['handling_charge'], 'pp_dt'=>NOW);
            $event_price_ins = $conn->insert(PRODUCTPRICE,"",$event_price_add);
          }
        }
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form role="form" method="post" name="frm_new" id="frm_new" action="" enctype="multipart/form-data">
                <div class="pull-right">
                  <button class="btn btn-primary" name="<?php echo $btn_name; ?>" id="<?php echo $btn_name; ?>" type="submit">Submit</button>
                ...
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Product Image</a></li>
                  <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Specifications</a></li>
                  <li role="presentation" id="month_div"><a href="#house_price" aria-controls="house_price" role="tab" data-toggle="tab">Rent For Month</a>
...
<li role="presentation" id="hidden_div" style="display: none;"><a href="#event_price" aria-controls="event_price" role="tab" data-toggle="tab">Rent for Event</a></li>
                    ...
                    <div class="row mg-top">
                      <div class="table-responsive">
                        <table id="fileimage" class="table table-striped table-bordered table-hover">
                          <thead>
                            <tr>
                              <td class="text-left">Product Image Upload</td>
                            </tr>
                          </thead>
                          <tbody>
                            <?php 
...
function filedadd(document_row){
   var addpricehtml  = '<tr id="price-row' + document_row + '">'; 
     ...
     addpricehtml += '  <td class="text-right"><input type="hidden" name="product_price_detail[' + document_row + '][pp_id]" class="form-control" /><select name="product_price_detail[' + document_row + '][location_id]" class="form-control location_get"><option value = 0>Select Location</option>';
    <?php foreach($locations['result'] as $location) { ?>
