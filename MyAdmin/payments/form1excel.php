...
//$usermin = $conn->select_query(USERS,"user_id","user_status='Y' AND user_type='F' order by user_id asc","1");
$formdetails = $conn->select_query(RM4DETAILS,"*","RM4_status='Y' order by rm4_details_id desc","");
?>
<?php #Admin Html head
$conn->adminHtmlhead();
$conn->admninBody();
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="post" name="frm_new" id="frm_new" action="<?php echo ADMIN_URL; ?>rm4_details/excel_download.php" enctype="multipart/form-data" >
                <!-- text input -->
                <div class="form-inline">
                
                 <div class="form-group">
                  <label>Attendance Details<span class="text-red">*</span></label> 
                 </div> </br>
                    <div class="form-group">
                 <p style="margin-right:30px;">
                   <input name="reportdown" id="reportall" type="radio" checked="checked" value="all">&nbsp;  All </p></div>



                      <div class="form-group">
          <p><input name="reportdown" id="reportuser" type="radio" value=""> &nbsp; One Month </p>
   <div id="hideval1" class="form-inline">
                <div class="form-group">
                  <label> D From :<span class="text-red"></span></label>&nbsp;
              <input type="text" class="form-control validate[required]" placeholder="From" id="from_date" name="from_date"/>
              </div>
                             
                  <div class="form-group">
                  <label>D To <span class="text-red">*</span></label>
              <input type="text" class="form-control validate[required]" placeholder="From" id="to_date" name="to_date"/>
                </div>
              ...
              <input type="text" class="form-control validate[required]" placeholder="From" id="dt_to" name="dt_to"/>
                </div>
               </div>
				  </div>
                  </div>
