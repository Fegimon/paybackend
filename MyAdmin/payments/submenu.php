...
//$conn->valoperator("2");
$listcounts=$conn->getRow("Select * from (select count(ord_id) as pencount from ".ORDER." WHERE order_status_id='1' limit 1)as p, (select count(ord_id) as procount from ".ORDER." WHERE order_status_id='2' limit 1)as pr, (select count(ord_id) as shpcount from ".ORDER." WHERE order_status_id='3' limit 1)as shp, (select count(ord_id) as comcount from ".ORDER." WHERE order_status_id='5' limit 1)as com, (select count(ord_id) as cancount from ".ORDER." WHERE order_status_id='6' limit 1)as can");
 ?>
<div class="row">
