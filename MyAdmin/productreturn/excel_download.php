...
$orders=$conn->select_query(PRODUCTRETURN,"*","$cond order by id desc",""); 
...
$objPHPExcel->getActiveSheet()->SetCellValue('H2', 'Product Return Details');
...
$objPHPExcel->getActiveSheet()->setTitle('Product Return Report');
$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel5');
header('Content-type: application/vnd.ms-excel');
header('Content-Disposition: attachment; filename="Product Return Report.xls"');
