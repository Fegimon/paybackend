...
$sel = $conn->select_query(PRODUCTRETURN,"*","id='".$id."'","1");
 $order_status = $conn->select_query(PRODUCTRETURN,"*","status='".$sel['status']."' AND status='Y'","1");
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form role="form" class="form-horizontal" >
                ...
                <dl class="dl-horizontal">
                  <dt>Order Id :</dt>
                  <dd><?php echo $conn->stripval(ucfirst($orders['id']));?></dd>
                </dl>
                
                  <dl class="dl-horizontal">
                  <dt>Product Name :</dt>
                  <dd><?php echo ucfirst($sel['product_name']);?></dd>
                </dl>
                
                <dl class="dl-horizontal">
                  <dt>Comments :</dt>
                  <dd><?php echo ucfirst($sel['comments']);?></dd>
                </dl>				        
                <dl class="dl-horizontal">
                  <dt>Customer Email Id:</dt>
                  <dd><?php echo $conn->stripval(ucfirst($sel['date_time']));?></dd>
                </dl> 
                <!--               
                <dl class="dl-horizontal">
