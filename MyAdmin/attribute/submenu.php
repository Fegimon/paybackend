...
//$conn->valoperator("2");
$listcounts=$conn->getRow("Select * from (select count(at_id) as actcount from ".ATTRIBUTE." WHERE at_status='Y' limit 1)as a,(select count(at_id)inactcount   from ".ATTRIBUTE." WHERE at_status='N'  limit 1)as b");
 ?>
<div class="row">
