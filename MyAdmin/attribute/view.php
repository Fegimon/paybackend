...
$sel = $conn->select_query(AT,"*","at_id='".$id."'","1");
?>
<?php #Admin Html head
$conn->adminHtmlhead();
$conn->admninBody();
            ...
            <div class="box-body">
              <form role="form" class="form-horizontal" >
                ...
                <dl class="dl-horizontal">
                  ...
                  <dd><?php echo $conn->stripval(ucfirst($sel['at_name']));?></dd>
                </dl>
                <dl class="dl-horizontal">
                  <dt>Position:</dt>
                  <dd><?php echo $conn->stripval(ucfirst($sel['at_pos']));?></dd>
                </dl>
                <dl class="dl-horizontal">
                  <dt>DATE Added :</dt>
				  <dd><?php echo date('F d, Y h:mA', strtotime($sel['at_dt']));?></dd>
                </dl>
            </div>
            <!-- /.box-body --> 
            <!-- /.box --> 
