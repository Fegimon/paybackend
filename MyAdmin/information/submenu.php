...
//$conn->valoperator("2");
$listcounts=$conn->getRow("Select * from (select count(id) as actcount from ".INFORMATION." WHERE information_status='Y' limit 1)as a,(select count(id)inactcount   from ".INFORMATION." WHERE information_status='N'  limit 1)as b");
 ?>
<div class="row">
