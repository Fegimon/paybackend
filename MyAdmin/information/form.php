...
include "pageconfig.php";
  ...
  $id = $conn->variable($q);
  $sel = $conn->select_query(Information,"*","id='".$id."'","1");
  if(!$sel['nr'] && !empty($id))
{
...
if($id){
  ...
  if(isset($edit))
  {
      $ins = $conn->update(Information,"id='".$id."'",$new);
      if($ins)
      {
  ...
  if(isset($add))
{
    ...
    $new = array('information_status'=>'Y');
    $ins = $conn->insert(Information,"",$new);
    if($ins)
    {
...
<div class="wrapper">
                ...
                <div class="box-body">
                  <form role="form" method="post" name="frm_new" id="frm_new" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <input  name="name" id="name" type="text" class="form-control validate[required]" placeholder="Enter Name" maxlength="200" value="<?php echo $conn->stripval($sel['name']);?>" />
                    </div>
					<div class="form-group">
                  <label>Email <span class="text-red">*</span></label>
                  <input  name="email" id="email" type="text" class="form-control validate[required]" placeholder="Enter Percentage" maxlength="200" value="<?php echo $conn->stripval($sel['email']);?>" />
                  </div>
  ...
  <div class="form-group">
                  ...
                  <input  name="phone" id="phone" type="text" class="form-control validate[required]" placeholder="Enter Percentage" maxlength="200" value="<?php echo $conn->stripval($sel['phone']);?>" />
                  </div>
