...
$sel = $conn->select_query(PRODUCTTRANSFER,"*","id='".$id."'","1");
 $order_status = $conn->select_query(PRODUCTTRANSFER,"*","status='".$sel['status']."' AND status='Y'","1");
              ...
              <form role="form" class="form-horizontal" >
               ...
               <dl class="dl-horizontal">
                ...
                <dl class="dl-horizontal">
                  ...
                  <dd><?php echo $conn->stripval($sel['number']);?></dd>
                </dl>                <!--               
                <dl class="dl-horizontal">
