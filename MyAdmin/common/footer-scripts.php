...
<script src="<?php echo ADMIN_URL; ?>plugins/datetime-picker/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php echo ADMIN_URL; ?>plugins/datetime-picker/bootstrap-datetimepicker.min.css" type="text/css"/>
...
$("#from_date").on("dp.change", function (e) {
           ...
           $('#to_date').data("DateTimePicker").maxDate(date1);
        });
</script>