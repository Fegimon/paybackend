...
if($func=="fileupload")
{
	...
	for($i=0;$i<100;$i++)
	{
		...
		$Orgexist = $conn->image_exist($uploadFilename,"../../uploads/banner/");
	...
	$key = $movefileName;
	$url = ADMIN_URL.'common/ajaxDelete.php?name='.$movefileName.'&func=deletetemp';
	$p1[$i] = "<img src='".SITE_URL."timthumb.php?src=".SITE_URL.UPLOADTEMPFOLDER.$movefileName."&h=160&zc=0&q=85' class='file-preview-image'>";
	$p2[$i] = array('caption' =>$movefileName, 'width' => '120px','url' => $url,'key' => $key);
