  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <?php /*?><b>Version</b> 2.0<?php */?>
    </div>
    <strong>Copyright &copy; <?php echo date('Y'); ?> <?php /*?><a href="http://www.mirrorminds.in" target="http://www.mirrorminds.in">Mirrorminds</a><?php */?></strong> All rights reserved. </footer>
  <?php /*?> <!-- Control Sidebar -->
  <aside class="control-sidebar control-sidebar-dark"> 
    ...
    <!-- T<div class="tab-pane" id="control-sidebar-home-tab">
