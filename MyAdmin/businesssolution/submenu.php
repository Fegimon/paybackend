...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
//$conn->valoperator("2");
$listcounts=$conn->getRow("Select * from (select count(tl_id) as actcount from ".BUSINESSSOLUTION." WHERE tl_status='Y' limit 1)as a,(select count(tl_id)inactcount   from ".BUSINESSSOLUTION." WHERE tl_status='N'  limit 1)as b");
 ?>
<div class="row">
