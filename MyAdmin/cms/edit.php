...
#Fetch value
$id = $conn->variable($q);
$res = $conn->select_query(TLINK,"*","tl_id='".$id."'","1");
if(!$res['nr'])
{
...
{	
		...
		$ins = $conn->update(TLINK,"tl_id='".$id."'",$new);
		if($ins)
		{
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="19%" class="form_text">Enter page name</td>
                        <td width="4%" align="center" class="form_text">:</td>
                        <td width="77%" class="form_text"><input name="tl_name" id="tl_name" value="<?php echo $res['tl_name']; ?>" type="text" size="45" /></td>
                      </tr>
                        <tr class="row_color">
                          <td width="19%" valign="top" class="form_text">Enter the Content </td>
                          <td width="4%" align="center" valign="top" class="form_text">:</td>
                          <td width="77%" class="form_text innertop_tablepad" style="padding:10px"><textarea name="tl_content" id="tl_content" cols="75"  class="form-control"  rows="10"><?php echo $res['tl_content']; ?></textarea><script>oEdit1.REPLACE("tl_content");</script></td>
                        </tr>
                        
                        
                        <?php if($res['tl_id']=='2'){?>
                        <tr class="row_color">
                          <td width="19%" valign="top" class="form_text">Map </td>
                          <td width="4%" align="center" valign="top" class="form_text">:</td>
                          <td width="77%" class="form_text innertop_tablepad" style="padding:10px"><textarea name="tl_map" id="tl_map" cols="30"  class="form-control"  rows="7"><?php echo $res['tl_map']; ?></textarea> <span class="text-light-blue" style="font-size:12px"> <?php echo htmlentities('Ex :<iframe src="https://www.google.com/maps/embed?pb=123456" width="100%" height="350" frameborder="0" style="border:0"></iframe>'); ?> </span></td>
                        </tr>
                        <?php }?>
                        
                  <tr class="head_bg">
                    <td height="28" colspan="3" class="form_head">SEO Settings </td>
                    </tr>
                      <tr class="row_color">
                        <td width="19%" class="form_text">Title</td>
                        <td width="4%" align="center"  class="form_text">:</td>
                        <td width="77%" class="form_text" height="70"><input type="text" name="tl_seo_title" id="tl_seo_title" value="<?php echo $res['tl_seo_title']; ?>" size="75" /><br /><b>Most search engines use a maximum of 60 chars for the title.</b></td>
                      </tr>
                      <tr>
