...
if(isset($_REQUEST['type']))
{
	...
	$select=mysql_query("select * from tbl_tlink where tl_slug='".$tl_slug."'") or die(mysql_error());
	...
	$insert=mysql_query("insert into tbl_tlink(tl_name,tl_split,tl_slug,tl_content,tl_seo_title,tl_seo_description,tl_seo_keywords,tl_dt,tl_status) values('$tl_name','$tl_split','$tl_slug','$tl_content','$tl_seo_title','$tl_seo_description','$tl_seo_keywords','$tl_date','$tl_status')") or die(mysql_error());
	
	echo'<script language=javascript>alert("Record Inserted successfully");</script>';
	echo'<script language=javascript>window.location.href="view_tlink.php"</script>';
}
