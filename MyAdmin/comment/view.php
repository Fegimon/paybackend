            ...
            <div class="box-body">
              <form role="form" class="form-horizontal" >
                ...
                <dl class="dl-horizontal">
                  <dt>Name :</dt>
                  <dd><?php echo $conn->stripval(ucfirst($sel['lt_name']));?></dd>
                </dl>
                 <dl class="dl-horizontal">
                  <dt>Designation :</dt>
                  <dd><?php echo $conn->stripval(ucfirst($sel['lt_designation']));?></dd>
                </dl>
                 <dl class="dl-horizontal">
                  <dt>Description :</dt>
                  <dd><?php echo $conn->stripval(ucfirst($sel['lt_desc']));?></dd>
                </dl>

                 <dl class="dl-horizontal">
                  <dt>Image  :</dt>
				  <?php $TMexist = $conn->image_exist($sel['lt_profile'],"../../".$uploadFolder);
						$img = ($TMexist) ? $uploadFolder.$sel['lt_profile'] : "images/noimg.jpg";?>
                  <dd><img class="media-object" src="<?php echo SITE_URL; ?>timthumb.php?src=<?php echo SITE_URL.$img;?>&w=200&h=86&zc=0" border="0" /></dd>
                </dl>
                <dl class="dl-horizontal">
                  <dt>DATE :</dt>
				  <dd><?php echo ($sel['lt_date_dt']=="0000-00-00")?"-":date('d-m-Y',strtotime($sel['lt_date_dt']));?></dd>
                </dl>
            </div>
            <!-- /.box-body --> 
            <!-- /.box --> 
