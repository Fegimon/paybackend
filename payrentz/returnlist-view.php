	...
	<section class="content">
		<div class="row">
			...
			<div class=" searchspace" >
			   ...
			   <button type="button" class="btn btns btn-labeled btn-default btn-defaults" style="margin-right: 5px;margin-bottom: 10px;" onclick="exporte('1','customer','return')">
        ...
        <table id="re_list" class="display" cellspacing="0" width="100%">
         <thead>
            <tr>
             <th>S.No</th>
             <th>Product ID</th>
