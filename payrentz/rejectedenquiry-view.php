	...
	<section class="content">
		<div class="row">
			...
			<div class="row searchspace">
			   <button type="button" class="btn btns btn-labeled btn-default btn-defaults"  style="margin-right: 5px;" onclick="exporte('1','customer','renq')">
                <span class="btn-label-default"> <i class="fa fa-file-excel-o" aria-hidden="true"></i></span>  Enquiry Details  
			   </button>
			   <button type="button" class="btn btns btn-labeled btn-default btn-defaults"  style="margin-right: 5px;" onclick="exporte('1','customer','renq_produt')">
                <span class="btn-label-default"> <i class="fa fa-file-excel-o" aria-hidden="true"></i></span>  Enquiry Product Details 
			   </button>
            ...
            <div class="box-body">
             ...
             <form id="frm-example">
				<table id="rejectedEnquiry" class="display" cellspacing="0" width="100%">
				 <thead>
					  <tr>
		...
		<div class="box box-primary" id="equiry_view" >
			...
			<div class="col-lg-12">
				<div class="form-group col-sm-3">
                  <label for="inputEmail3" class="col-lg-12 control-label">Enquiry ID</label>
                ...
                <div class="form-group col-sm-3">
                  <label for="inputEmail3" class="col-lg-12 control-label">Customer ID</label>
                  ...
                  <div class="col-lg-12">
                    <input type="" class="form-control" id="cus_id" name="e_cus_id" placeholder="Customer ID / Mobile"  disabled="disabled">
							...
							<div class="form-group col-sm-3">
							  <label for="cus_name" class="col-lg-12 control-label">Customer Name</label>
				...
				<div class="form-group col-sm-3">
							  <label for="cus_name" class="col-lg-12 control-label">Mobile no.</label>

							  <div class="col-lg-12">
								<input type="text" class="form-control" name='e_mobile' id='e_mobile' placeholder="Customer Name" disabled="disabled">								
							  </select>
							  </div>
							</div>
				
							<div class="form-group col-sm-3">
							  <label for="cus_name" class="col-lg-12 control-label">Email Id</label>

							  <div class="col-lg-12">
								<input type="text" class="form-control" name='e_email' id='e_email' placeholder="Customer Name" disabled="disabled">								
							  </select>
							  </div>
							</div>
                ...
                <div class="form-group col-sm-3">
                  <label for="datepicker" class="col-lg-12 control-label">Date of Enquiry</label>
				...
				<div class="form-group col-sm-3">
                  <label for="attendby" class="col-lg-12 control-label">Attended By</label>
                  <div class="col-lg-12">
				...
				<div class="form-group col-sm-3">
                  <label for="assignby" class="col-lg-12 control-label">Assigned To</label>
                  <div class="col-lg-12">
				...
				<div class="form-group col-sm-3">
                  <label for="datepicker1" class="col-lg-12 control-label">Follow-up On</label>
				...
				<div class="form-group col-sm-3">
                  <label for="remark1" class="col-lg-12 control-label">Remarks</label>

                  <div class="col-lg-12">
                    <textarea class="form-control" rows="3" cols="50" id="remark" name="e_remark" placeholder="Enter ..." disabled="disabled" style="    height: 50px !important;"></textarea>	
                  </div>
                </div>
</div>				
