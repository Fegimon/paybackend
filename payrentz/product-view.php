...
<div class="input-group">
	...
	<div class="row">
		 <div class="form-group col-sm-4">
                  <label for="produc_id" class="col-sm-12 control-label">Product Id</label>
                  <div class="col-sm-12">
                 <input type="text" class="form-control" id="produc_id" value="" disabled>
                   </div>       
                </div>
        <div class="form-group col-sm-4" >
                  <label for="product_category" class="col-sm-12 control-label">Product Category</label>
                  <div class="col-sm-12">
           <input type="text" class="form-control" id="product_category" value="" disabled>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewvariant" class="col-sm-12 control-label">Variant</label>
                  <div class="col-sm-12">
          <input type="text" class="form-control" id="viewvariant" value="" disabled>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewbrand" class="col-sm-12 control-label">Brand</label>
                  <div class="col-sm-12">
        ...
        <div class="form-group col-sm-4">
                  <label for="viewowned" class="col-sm-12 control-label">Type</label>
                 <div class="col-sm-12">
                ...
                <div class="form-group col-sm-4">
                  <label for="viewvendor" class="col-sm-12 control-label">Vendor</label>
                  <div class="col-sm-12">
          <input type="text" class="form-control" id="viewvendor" value="" disabled>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewpurchasedate" class="col-sm-12 control-label">Date of Purchase</label>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewpurchase_value" class="col-sm-12 control-label">Purchase Value</label>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewother_charge" class="col-sm-12 control-label">Other Charges</label>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewserialno" class="col-sm-12 control-label">Manufacturer's Serial No</label>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewwarranty" class="col-sm-12 control-label">Warranty Period</label>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewbillnumber" class="col-sm-12 control-label">Bill Number</label>
        ...
        <div class="form-group col-sm-4">
                  <label for="viewlocation" class="col-sm-12 control-label">Location</label>
                    <div class="col-sm-12">
        ...
        <div class="box box-info">
			...
			<div class="row">
				...
				<div class="form-group col-sm-4">
                  <label for="viewrent" class="col-sm-12 control-label">Rent</label>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewprocessing_fee" class="col-sm-12 control-label">Processing Fee</label>
                ...
                <div class="form-group col-sm-4">
                  <label for="viewsecurity_deposit" class="col-sm-12 control-label">Security Deposit</label>
          ...
          <div class="col-sm-12 pull-right" id="editimagediv">                
            ...
            <div class="form-group">
              <label for="" class="col-sm-12 control-label">Bill Upload</label>
                <div class="col-sm-6">                  
                <div style="height:100px; border: 1px solid #ccc;overflow: auto;background: url(assets/images/placeholder-img.png);" id="imageothers"></div><br/>          
              ...
              <div class="col-sm-6">
                <div style="height:100px; border: 1px solid #ccc;overflow: auto;background: url(assets/images/placeholder-img.png);" id="dispyproductimages"></div><br/>         
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="form-group">
             ...
             <div class="col-sm-12">
              <input type="number" min="0" class="form-control" id="editpropurchase_value" name="editpropurchase_value" placeholder="Purchase Value">
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="form-group">
             ...
             <div class="col-sm-12">
              <input  type="number" min="0" class="form-control" id="editproother_charge" name="editproother_charge" placeholder="Other Charges">
        ...
        <div class="col-lg-3">
          <div class="form-group">
              <label for="editprorent" class="col-sm-12 control-label">Rent</label>
        ...
        <div class="col-lg-3">
          <div class="form-group">
            <label for="editproprocessing_fee" class="col-sm-12 control-label">Processing Fee</label>
           ...
           <div class="col-sm-12">
            <input type="text"  name="editprosecurity_deposit" disabled class="form-control" id="editprosecurity_deposit" placeholder="Security Deposit">
              ...
              <div class="box-footer">
                <a class="btn btn-default" onclick="showtablehideview()">Cancel</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Closure</h4>
      </div>
				...
				<form class="form-horizontal">
				 <div class="box-body">
					...
					<div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="proId" class="col-sm-5 control-label">Product Id</label>
						  <div class="col-sm-12">
					...
					<div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="cusId" class="col-sm-5 control-label">Customer Id</label>
						  <div class="col-sm-12">
				...
				<form class="form-horizontal">
				 <div class="box-body">
					...
					<div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="proId1" class="col-sm-5 control-label">Product Id</label>
						  <div class="col-sm-12">
					...
					<div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="cusId1" class="col-sm-5 control-label">Customer Id</label>
						  <div class="col-sm-12">
						...
						<div class="form-group">
						  <label for="returndate" class="col-sm-5 control-label">Return Date</label>
						  <div class="col-sm-12">
...
<div class="modal fade" id="refundModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				...
				<form class="form-horizontal">
				 <div class="box-body">
					...
					<div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="r_proId" class="col-sm-5 control-label">Product Id</label>
						  <div class="col-sm-12">
					...
					<div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="r_cId" class="col-sm-5 control-label">Customer Id</label>
						  <div class="col-sm-12">
						...
						<div class="form-group">
						  <label for="r_closuredate" class="col-sm-5 control-label">Closure Date</label>
						  <div class="col-sm-12">
 ...
 <div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="r_pend" class="col-sm-5 control-label">Pennding Amount</label>
						  <div class="col-sm-12">
              ...
              <div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="r_rent" class="col-sm-5 control-label">Rent Cost</label>
						  <div class="col-sm-12">
                     ...
                     <div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="r_advance" class="col-sm-5 control-label"> Advance Amount</label>
						  <div class="col-sm-12">
					 ...
					 <div class="col-lg-12">	  
						...
						<div class="form-group">
						  <label for="r_refund" class="col-sm-5 control-label">Refund Amount</label>
						  <div class="col-sm-12">
					...
					<div class="form-group">
                  <label for="r_remark" class="col-sm-12 control-label">Remarks</label>
