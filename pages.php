...
$terms_cont = $conn->select_query(TLINK,"*","tl_slug='".$slug."'","1");
if($slug!='' && !$terms_cont['nr'])
{
...
<img src="<?php echo SITE_URL ?>images/new-banner.png" class="img-responsive" alt=""/>
    <div class="container">
    <h1 class="banner-title">  <?php echo  $terms_cont['tl_name']; ?> </h1>
    </div>
</section>
...
<div class="container-fluid">
    <div class="pull-left">
        <ol class="breadcrumb">
          ...
          <li class="active"> <?php echo  $terms_cont['tl_name']; ?> </li>
        </ol>
