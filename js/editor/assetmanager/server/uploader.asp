               ...
               oUploadFile.Length = FindToken(vDataSep, nCurPos) - 2 - nCurPos
				...
				If oUploadFile.Length > 0  Then 
					select case lcase(getFileExtension(oUploadFile.FileName))
						...
						case "jpg","jpeg","jpe","jp2","jfif","gif","bmp","png","psd","eps","ico","tif","tiff","ai","raw","tga","mng","svg","doc","rtf","txt","wpd","wps","csv","xml","xsd","sql","pdf","xls","mdb","ppt","docx","xlsx","pptx","ppsx","artx","mp3","wma","mid","midi","mp4","mpg","mpeg","wav","ram","ra","avi","mov","flv","m4a","m4v","htm","html","css","swf","js","rar","zip","tar","gz"
