    ...
    <script language="javascript" type="text/javascript">
        ...
        function panelUpload() {
            ...
            $("#File1").uploadify({
                ...
                'script': 'server/upload.asp?folder=' + $("#active_folder").val(),
...
<body style="margin:0px;background:#ffffff;font-family:Arvo;font-size:12px">
    ...
    <div style="padding:15px;background:#fcfcfc;border-bottom:#f7f7f7 1px solid">
        ...
        <div style="margin-top:12px;margin-bottom:7px;">
            ...
            <a href="javascript:preview()" style="margin-right:10px;font-size:10px;color:#000;">PREVIEW</a>
        </div>

        <div id="divUpload" style="padding:17px;border:#f3f3f3 1px solid;background:#fefefe;">
        </div>
        ...
        <div id="divPreview" style="position:relative;padding:17px;border:#f3f3f3 1px solid;height:65px;background:#fefefe;">
            <div id="preview_id" style="position:absolute;left:20px;top:15px;width:80px;height:80px;text-align:right;">    
            </div>
        </div>
