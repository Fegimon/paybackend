  ...
  <div class="container-fluid">
    <div class="pull-left">
      <ol class="breadcrumb">
        ...
        <li class="active">Reference Details</li>
      </ol>
    </div>
    ...
    <div class="row">
     ...
     <div class="btn-group btn-breadcrumb breadcrumb-color">
            ...
            <a href="<?php echo SITE_URL; ?>professional-details.html" class="btn btn-default "> 2. Professional Details</a>
             <a href="<?php echo SITE_URL; ?>reference-details.html" class="btn btn-success active"> 3. Reference Details</a>
...
<div>&nbsp;</div>
      ...
      <h3>Reference Details - <?php echo $conn->stripval($userdetails['payrentz_unique']);?></h3>
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
   ...
   <label for="name-1">Reference Name 1</label>
    <input type="text" class="form-control" name="reference_name1" id="reference_name1" value="<?php echo  $userdetails['reference_name1']; ?>">

    </div>
    
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
<label for="name-2">Reference Name 2</label>
    <input type="text" name="reference_name2" id="reference_name2" class="form-control" id="name-2"  value="<?php echo  $userdetails['reference_name2']; ?>">
    </div> 
    </div>
...
<div class="form-group">   
   ...
   <label for="email-id">Email ID:</label>
    <input type="email-id" name="Reference1_email1" class="form-control" id="Reference1_email1" value="<?php echo  $userdetails['Reference1_email1']; ?>">

    </div>
    
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
<label for="email-id">Email ID: </label>
    <input type="email-id" class="form-control" name="Reference2_email2" id="Reference2_email2" value="<?php echo  $userdetails['Reference2_email2']; ?>">
    </div>
    </div> 
    ...
    <textarea class="form-control" id="Reference1_adress" name="Reference1_adress"  rows="3"><?php echo  $userdetails['Reference1_adress']; ?></textarea>

    </div>
    
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
 <label for="address"> Address :</label>
    <textarea class="form-control" id="Reference2_adress" name="Reference2_adress" rows="3"><?php echo  $userdetails['Reference2_adress']; ?></textarea>
    </div>
    </div> 
   <div class="form-group">   
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <label for="contact"> Contact #</label>
<input type="contact" class="form-control" name="Reference1_contact" id="Reference1_contact" value="<?php echo  $userdetails['Reference1_contact']; ?>">

    </div>
    
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
 <label for="contact"> Contact #</label>
<input type="contact" class="form-control" name="Reference2_contact" id="Reference2_contact" value="<?php echo  $userdetails['Reference2_contact']; ?>">
    </div>
    </div> 
    ...
    <div> &nbsp;</div>
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="pull-left">
   <a  href="professional-details.php" class="btn btn-success btn-md">Previous</a>
     </div>
